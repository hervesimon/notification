...
public interface UsersApi {
    ...
    ResponseEntity<UserInfoJson> getUsersByUserId(
    ...
    ResponseEntity<List<TripResponseJson>> getUsersTrips(
    ...
    ResponseEntity<String> postUserRegister(
    ...
    ResponseEntity<String> postUsersLogin(
     ...
     * Retrieve the notifications information of the user with the matching user ID.
     *
     * @param username The unique identification of an user (required)
     * @return Trips Found (status code 200)
     *         or Forbidden (status code 403)
     ...
     */
    @Operation(
            operationId = "getUsersNotification",
            summary = "Get User notifications",
            tags = { "Users", "Notifications" },
            responses = {
                    @ApiResponse(responseCode = "200", description = "Trips Found", content = {
                            @Content(mediaType = "application/json", schema = @Schema(implementation = NotificationJson.class))
                    }),
                    @ApiResponse(responseCode = "403", description = "Forbidden"),
                    @ApiResponse(responseCode = "404", description = "User Not Found"),
                    @ApiResponse(responseCode = "500", description = "Internal Server Error", content = {
    ...
    @RequestMapping(
            method = RequestMethod.GET,
            value = "/users/{username}/notifications",
            produces = { "application/json" }
    )
    ResponseEntity<List<NotificationJson>> getUsersNotification(
    @Parameter(name = "username", description = "The unique identification of an user", required = true) @PathVariable("username") String username
    );
}
